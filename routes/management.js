...
// 도서 등록
router.post("/api/management/bookAdd", upload.single("cover"), async (req, res) => {
    const { title, author, publisher, publicationDate, count, registrationDate, group, registeredBy } = req.body;
