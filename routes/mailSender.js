...
function rentalRequestTemplate(data) {
    ...
    <td class="content">
        <table cellspacing="0" cellpadding="0" width="100%">
            <tbody>
                <tr>
                    <td class="title">${data.recipient.subject}</td>
                </tr>
                <tr>
                    <td height="42"></td>
                </tr>
                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%">
                            <tbody>
                                <tr>
                                    <td class="section-title">대여 요청 도서 정보</td>
                                </tr>
                                <tr>
                                    <td height="6"></td>
                                </tr>
...
*/
  const { templateName, sender, recipient, bookInfo, approvalInfo } = req.body; // 요청 바디에서 데이터 가져오기

	if (!templates[templateName]) {
		return res.status(400).send({ message:'잘못된 템플릿 이름입니다.'});
	}
  ...
  // HTML 템플릿에 데이터 삽입
  const htmlContent = templates[templateName]({ sender, recipient, bookInfo, approvalInfo });
